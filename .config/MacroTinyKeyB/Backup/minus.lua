-- Macro script for key: minus
-- This script is executed when 'minus' is pressed

print("Key minus was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from minus'")
-- os.execute("notify-send 'Macro' 'Key minus pressed'")
