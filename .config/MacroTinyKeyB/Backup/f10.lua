-- Macro script for key: f10
-- This script is executed when 'f10' is pressed

print("Key f10 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from f10'")
-- os.execute("notify-send 'Macro' 'Key f10 pressed'")
