-- Macro script for key: f7
-- This script is executed when 'f7' is pressed

print("Key f7 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from f7'")
-- os.execute("notify-send 'Macro' 'Key f7 pressed'")
