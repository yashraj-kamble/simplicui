-- Macro script for key: equal
-- This script is executed when 'equal' is pressed

print("Key equal was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from equal'")
-- os.execute("notify-send 'Macro' 'Key equal pressed'")
