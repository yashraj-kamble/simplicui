-- Macro script for key: backspace
-- This script is executed when 'backspace' is pressed
...
-- os.execute("echo 'Hello from backspace'")
-- os.execute("notify-send 'Macro' 'Key backspace pressed'")
