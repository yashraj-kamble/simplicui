-- Macro script for key: f8
-- This script is executed when 'f8' is pressed

print("Key f8 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from f8'")
-- os.execute("notify-send 'Macro' 'Key f8 pressed'")
