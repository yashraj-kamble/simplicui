-- Macro script for key: lctrl
-- This script is executed when 'lctrl' is pressed

print("Key lctrl was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from lctrl'")
-- os.execute("notify-send 'Macro' 'Key lctrl pressed'")
