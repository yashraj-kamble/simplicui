-- Macro script for key: semicolon
-- This script is executed when 'semicolon' is pressed

print("Key semicolon was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from semicolon'")
-- os.execute("notify-send 'Macro' 'Key semicolon pressed'")
