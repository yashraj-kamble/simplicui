-- Macro script for key: tab
-- This script is executed when 'tab' is pressed

print("Key tab was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from tab'")
-- os.execute("notify-send 'Macro' 'Key tab pressed'")
