-- Macro script for key: leftmeta
-- This script is executed when 'leftmeta' is pressed

print("Key leftmeta was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from leftmeta'")
-- os.execute("notify-send 'Macro' 'Key leftmeta pressed'")
