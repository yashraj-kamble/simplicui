-- Macro script for key: kp4
-- This script is executed when 'kp4' is pressed

print("Key kp4 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from kp4'")
-- os.execute("notify-send 'Macro' 'Key kp4 pressed'")
