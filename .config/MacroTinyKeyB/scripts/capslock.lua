-- Macro script for key: capslock
-- This script is executed when 'capslock' is pressed

print("Key capslock was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from capslock'")
-- os.execute("notify-send 'Macro' 'Key capslock pressed'")
