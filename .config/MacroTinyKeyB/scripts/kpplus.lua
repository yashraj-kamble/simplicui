-- Macro script for key: kpplus
-- This script is executed when 'kpplus' is pressed

print("Key kpplus was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from kpplus'")
-- os.execute("notify-send 'Macro' 'Key kpplus pressed'")
