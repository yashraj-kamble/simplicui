-- Macro script for key: f12
-- This script is executed when 'f12' is pressed

print("Key f12 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from f12'")
-- os.execute("notify-send 'Macro' 'Key f12 pressed'")
