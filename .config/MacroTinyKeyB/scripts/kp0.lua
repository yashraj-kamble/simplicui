-- Macro script for key: kp0
-- This script is executed when 'kp0' is pressed

print("Key kp0 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from kp0'")
-- os.execute("notify-send 'Macro' 'Key kp0 pressed'")
