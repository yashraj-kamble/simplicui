-- Macro script for key: kp1
-- This script is executed when 'kp1' is pressed

print("Key kp1 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from kp1'")
-- os.execute("notify-send 'Macro' 'Key kp1 pressed'")
