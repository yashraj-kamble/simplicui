-- Macro script for key: f11
-- This script is executed when 'f11' is pressed

print("Key f11 was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from f11'")
-- os.execute("notify-send 'Macro' 'Key f11 pressed'")
