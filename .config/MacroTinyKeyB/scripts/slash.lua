-- Macro script for key: slash
-- This script is executed when 'slash' is pressed

print("Key slash was pressed!")

-- Insert your macro code here
-- Examples:

-- os.execute("echo 'Hello from slash'")
-- os.execute("notify-send 'Macro' 'Key slash pressed'")
